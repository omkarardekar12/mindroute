...
export default function AddForm() {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="flex items-center justify-center px-5 py-3 bg-blue-600 rounded-xl font-semibold text-white hover:bg-blue-700 transition-all duration-200 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
